...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin/packages/')->name('backend.packages.')->group(function () {
        ...
        Route::post('/{uuid}/restore', [PackageController::class, 'restore'])->name('restore');
        Route::delete('/{uuid}/force-delete', [PackageController::class, 'forceDelete'])->name('forceDelete');
