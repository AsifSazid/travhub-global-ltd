                    ...
                    hotels.forEach((city, index) => {
                        const row = `
                                <tr>
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="/cities/${city.city?.uuid}">${city.city?.title ?? 'N/A'}</a>
                                    </td>
                                    <td class="px-6 py-4">${city.user?.title ?? 'N/A'}</td>
                                    <td class="px-6 py-4">
                                        <div class="flex justify-center">
                                            <a href="/hotels/${city.uuid}" class="px-1 text-blue-500 hover:text-blue-700" title="View"><i class="fas fa-eye"></i></a>
                                            <a href="/hotels/${city.uuid}/edit" class="px-1 text-yellow-500 hover:text-yellow-700" title="Edit"><i class="fas fa-edit"></i></a>
                                            <form action="/hotels/${city.uuid}" method="POST" onsubmit="return confirm('Move to trash?')">
