<x-backend.layouts.master>
    ...
    <div class="overflow-x-auto">
        ...
        <form action="{{ route('current_rates.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-4">
                <label for="rate_value" class="block text-sm font-medium text-gray-700">Currency Rate Value</label>
