<x-backend.layouts.master>
    ...
    <div class="overflow-x-auto">
        <table id="roleTable" class="w-full table-striped table-bordered text-sm">
            <thead class="bg-gray-100 text-gray-700 uppercase">
                <tr>
                    ...
                    <th class="px-6 py-4">City Code</th>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex justify-center space-x-2">
                                <form action="{{ route('cities.restore', $trashed->uuid) }}" method="POST"
                                    class="d-inline">
                                    @csrf
                                ...
                                <form action="{{ route('cities.forceDelete', $trashed->uuid) }}" method="POST"
                                    class="inline ml-2"
        ...
        <div class="mt-4 px-4 py-2 bg-gray-100 border-t text-sm text-gray-500 flex justify-between items-center">
            <a href="{{ route('cities.index') }}" class="text-blue-500 hover:text-blue-700 mx-1"
                title="City Lists"><i class="fas fa-trash-alt"></i> City Lists</a>
        </div>
    </div>
