<x-backend.layouts.master>
    ...
    <div class="overflow-x-auto">
        <table id="roleTable" class="w-full table-striped table-bordered text-sm">
            <thead class="bg-gray-100 text-gray-700 uppercase">
                <tr>
                    ...
                    <th class="px-6 py-4">Package Code</th>
            ...
            <tbody class="text-center">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex justify-center space-x-2">
                                <form action="{{ route('packages.restore', $trashed->uuid) }}" method="POST"
                                    class="d-inline">
                                    @csrf
                                ...
                                <form action="{{ route('packages.forceDelete', $trashed->uuid) }}" method="POST"
                                    class="inline ml-2"
                ...
                @empty
                    <tr>
                        <td colspan="7" class="py-4 text-center text-gray-500">No package found!
                        </td>
                    </tr>
                @endforelse
            </tbody>
        ...
        <div class="mt-4 px-4 py-2 bg-gray-100 border-t text-sm text-gray-500 flex justify-between items-center">
            <a href="{{ route('packages.index') }}" class="text-blue-500 hover:text-blue-700 mx-1"
                title="Package Lists"><i class="fas fa-trash-alt"></i> Package Lists</a>
        </div>
    </div>
