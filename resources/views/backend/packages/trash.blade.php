<x-backend.layouts.master>
    ...
    <div class="overflow-x-auto">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex justify-center space-x-2">
                                <form action="{{ route('backend.packages.restore', $trashed->uuid) }}" method="POST"
                                    class="d-inline">
                                    @csrf
                                ...
                                <form action="{{ route('backend.packages.forceDelete', $trashed->uuid) }}" method="POST"
                                    class="inline ml-2"
        ...
        <div class="mt-4 px-4 py-2 bg-gray-100 border-t text-sm text-gray-500 flex justify-between items-center">
            <a href="{{ route('backend.packages.index') }}" class="text-blue-500 hover:text-blue-700 mx-1"
