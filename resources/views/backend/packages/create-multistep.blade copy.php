...
<head>
    ...
    <title>Create Package - Multi Step</title>
...
<body class="bg-gray-50 min-h-screen p-6">
    <div class="max-w-5xl mx-auto">
        <div class="bg-white rounded-xl shadow p-6" x-data="packageForm()" x-init="init()">

            <!-- Header -->
            <div class="flex items-center justify-between mb-6">
                <h1 class="text-2xl font-semibold">Create Package (Step-by-step)</h1>
                <div class="text-sm text-gray-600" x-text="`Step ${step} / ${totalSteps}`"></div>
            </div>

            <!-- Progress -->
            <div class="mb-6">
                <div class="w-full bg-gray-200 h-2 rounded-full overflow-hidden">
                    <div class="h-2 bg-indigo-600 transition-all duration-300"
                ...
                <div x-show="step===2" x-cloak x-data="citySelector($root)" class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select x-model="$root.form.activity_category_id"
                                class="mt-1 w-full border rounded px-3 py-2">
                ...
                <div x-show="step===4" x-cloak>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input x-model="form.accomo_cities" type="text"
                                class="mt-1 w-full border rounded px-3 py-2" />
                        </div>
                ...
                <div x-show="step===6" x-cloak>
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div>
                            ...
                            <input x-model="form.inclusions" type="text"
                                class="mt-1 w-full border rounded px-3 py-2"
