<x-backend.layouts.master>
    <x-slot name="header">
        <div class="flex items-center justify-between px-4 py-4 border-b lg:py-6 dark:border-primary-darker">
            <h2 class="text-2xl font-semibold">{{ __('Roles') }}</h2>
            <a href="{{ route('roles.create') }}" class="text-green-500 hover:text-green-700 mx-1" title="Create">
    ...
    <div class="overflow-x-auto">
        ...
        <div class="mt-4 px-6">
            ...
            <div class="px-4 py-2 bg-gray-100 border-t text-sm text-gray-500 flex justify-between items-center">
                {{-- <a href="{{ route('roles.trash') }}" class="text-red-500 hover:text-red-700 mx-1" title="Trash Lists">
            ...
            document.addEventListener("DOMContentLoaded", () => {
                ...
                const renderTable = (roles) => {
                    ...
                    if (!roles || roles.length === 0) {
                        tableBody.innerHTML =
                            `<tr><td colspan="5" class="py-4 text-center text-gray-500">No roles found</td></tr>`;
                        return;
                    }
                    ...
                    roles.forEach((role, index) => {
                        const row = `
                                <tr>
                                    ...
                                    <td class="px-6 py-4">${role.user?.title ?? 'N/A'}</td>
