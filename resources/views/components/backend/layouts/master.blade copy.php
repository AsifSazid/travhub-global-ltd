...
<body>
    ...
    setColors(color);" :class="{ 'dark': isDark }">
        <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
            ...
            <!-- Sidebar -->
            <x-backend.layouts.partials.aside :navigations="''" />
            ...
            <div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
                ...
                <header class="relative bg-white dark:bg-darker">
                            ...
                            <div class="relative" x-data="{ open: false }">
                                <button @click="open = !open; $nextTick(() => { if(open){ $refs.userMenu.focus() } })"
                                    ...
                                    <span
                                        ...
                                        <span class="uppercase">{{ __('AM') }}</span>
                                    </span>
                                    {{-- <span
                                        class="w-10 h-10 rounded-full border-2 border-primary-500 shadow-md overflow-hidden bg-white dark:bg-gray-800 flex items-center justify-center text-sm font-semibold text-primary-700 dark:text-primary-300">
                    ...
                    <!-- Mobile main manu -->
                    <x-backend.layouts.partials.aside-mobile />
                </header>
                ...
                <!-- Main footer -->
                <x-backend.layouts.partials.footer :companyName={{ __('TravHub Global Limited') }} />
            </div>
